trackToGPX = function(tdf, outGPX){
  #' trackToGPX
  #' 
  ...
  #' date: 28 July 2023
  #'
  #' @param tdf data.frame of track segments. Must include the following 
  #' columns: uid, lat1, lon1, lat2, lon2
  #' @param outGPX fullpath filename of gpx to be written
  #' example: outGPX = './CRPTools/utils-R/exampleData/exampleVesselTrack.gpx'
  #' 
  #' @return none, will write a file
  #' @examples
  #' tdf = read.csv('./CRPTools/utils-R/exampleData/exampleVesselTrack.csv')
  #'  
  #' ######################################################################
  #'
  ...
  tt = subset(tdf, select = c(uid, lat1, lon1, lat2, lon2))
